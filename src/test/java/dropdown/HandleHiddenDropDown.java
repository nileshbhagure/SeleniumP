package dropdown;
/*
  We dont have any tag listed
  
 ways
 1. From Selectorhub turn on debugger option-> click on dropdown-> wait for 5 sec to see 
 2. for chrome->dev tool-> Event listerner tab-> from Blur folder remove 
 */
